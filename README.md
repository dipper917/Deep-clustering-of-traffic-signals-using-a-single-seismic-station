...
The field dataset used in this study can be downloaded from [Zenodo](https://doi.org/10.5281/zenodo.15356181). Please ensure that you download the appropriate dataset before running the code.  
